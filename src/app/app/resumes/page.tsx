...
/**
 * Every resume on the account, and the place to add one.
 *
 * This used to be the page after sign-in, and testers found it confusing:
 * they signed in to work on THEIR resume and met a grid of cards and a drop
 * zone instead. /app now opens the resume they are sending straight away;
 * this is the library behind it — reachable from the avatar menu, the phone
 * bar, and the back link on every workspace.
 */
export default async function AllResumesPage() {
  ...
  // at a deleted resume falls back to the newest one.
