...
import { Resume, Sparkle, Target, Clock, Star } from "@/components/Doodles";
  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-2">
      ...
      <aside className="relative hidden overflow-hidden border-r-2 border-ink bg-brand text-white lg:flex lg:flex-col lg:justify-between p-12">
        ...
        <Resume className="absolute right-10 top-24 z-[1] text-white/30 wobble" size={60} />
        <Sparkle className="absolute left-12 bottom-44 z-[1] text-white/25" size={34} />
        ...
        <div className="relative z-[2]">
          ...
          <ol className="mt-8 space-y-3.5 text-white/90">
            {([
              [Resume, "Upload once — that's your only homework"],
              [Target, "It scores every listing against your skills"],
              [Clock, "Auto-applies daily, within your limits"],
        ...
        <div className="relative z-[2] flex items-center gap-3 text-sm text-white/75">
          ...
          Join the intern grind — 5 platforms, one bot
        </div>
      </aside>
