...
export const PROFF_FIELDS: ProffField[] = [
  ...
  },
  {
    ...
    help: "Preset for an Indian citizen, because Grindly only applies to internships in India. Change it if that is not you.",
    type: "choice",
    options: [
      "Indian citizen",
  ...
  },
  {
    ...
    help: "Preset, because Grindly only applies to internships in India. Change it if that is not you.",
    type: "choice",
    options: ["India"],
